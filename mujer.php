...
<div class="container1">
 ...
 <?php
        $sentencia=$pdo->prepare("SELECT* FROM prenda_dama where cod_prendas like 'p%'");
        $sentencia->execute();
...
<li  width="25%" class="active">
      ...
      <!---->
        <?php
        $sentencia=$pdo->prepare("SELECT* FROM prenda_dama where cod_prendas like 'v%'");
        $sentencia->execute();
        $listaProductos=$sentencia->fetchAll(PDO::FETCH_ASSOC);
        //print_r($listaProductos);
      ?>
  ...
  <li width="25%">
    ...
    <div class="section-content">
      ...
      <!---->
     <?php
        $sentencia=$pdo->prepare("SELECT* FROM prenda_dama where cod_prendas like 'b%'");
        $sentencia->execute();
        $listaProductos=$sentencia->fetchAll(PDO::FETCH_ASSOC);
        //print_r($listaProductos);
      ?>
